      ...
      <div className="container relative z-10 mx-auto flex max-w-7xl flex-col items-center px-6 pb-24 md:px-8">
        <div className="flex flex-col items-center gap-10 text-center">
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 rounded-full border border-white/10 bg-white/[0.02] px-3 py-1.5 text-xs uppercase tracking-[0.3em] text-secondary">
              <span>Tailwind</span>
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 rounded-full border border-white/10 bg-white/[0.03] p-2 backdrop-blur-xl glass-surface gpu-accelerated">
            {personas.map((entry) => (
              <GlassButton
                key={entry.id}
                accent={entry.accent}
          ...
          <div className="relative max-w-5xl space-y-6">
            ...
            <p className="mx-auto max-w-3xl text-lg text-secondary md:text-xl lg:text-2xl text-fluid">
          ...
          <div className="grid w-full max-w-3xl grid-cols-1 gap-3 sm:grid-cols-3">
            {persona.stats.map((stat) => (
              <div
                key={stat.label}
                className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.03] p-6 text-left backdrop-blur-xl glass-surface hover-lift gpu-accelerated"
              >
                <div
            ...
            <div className="relative overflow-hidden rounded-3xl border border-white/12 bg-black/60 p-6 shadow-2xl glass-surface hover-lift">
              ...
              <div className="relative flex flex-col gap-4">
                <div className="flex items-center justify-between border-b border-white/10 pb-4">
                  <div className="flex items-center gap-2 text-xs uppercase tracking-[0.3em] text-secondary-light">
                    <span>Dark Deck</span>

...
if (fs.existsSync(gitignorePath)) {
  ...
  const missingPatterns = sensitivePatterns.filter(p => !gitignore.includes(p.replace('*', '')));
...
try {
  ...
  console.log('⚠️  Some dependencies are outdated. Run `pnpm outdated` for details.');
}
